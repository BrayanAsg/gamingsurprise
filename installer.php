...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_gamingsurprise_3b1a1cb9e7e3b2a41277_20221207125850_archive.zip';
        const ARCHIVE_SIZE       = '30185343';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3b1a1cb-07125850';
        const SECONDARY_PACKAGE_HASH = 'dd079b4-07125850';
        const VERSION            = '1.5.1';
